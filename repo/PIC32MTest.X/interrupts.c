...
#include "system.h"          /* typedef for data types.                      */

uint DELAY_COUNTER_10USEC;  /* 10 usec timer counter                */
uint DELAY_COUNTER_MSEC;    /* msec timer to delay                  */
...
void __ISR(_TIMER_1_VECTOR, IPL2SOFT) Timer1Handler(void)
{
    ...
    DELAY_COUNTER_10USEC++;

}

/* TODO Add serial interrupt routine code here. */
